 ...
 if (isset($_POST['submit'])) 
 {
   ...
   }else
   {
      ...
      if (isset($result)) {
        ...
        <p>Please open this link to verified your email address - ".$base_url."student_email_verification.php?su_activation_code=".$user_activation_code." <p>Best Regards, <br /> Voting</p>
        ";
