...
$message = '';
 ...
 if (isset($_POST['submit'])) 
 {
   ...
   }else
   {
      ...
      $insert_query = "
      INSERT INTO cd_register_user
      (CV_id, user_name, user_email, user_password, 
      user_activation_code, user_email_status) 
      VALUES (:CV_id, :user_name, :user_email, :user_password, 
      :user_activation_code, :user_email_status)
      ";
      ...
      if (isset($result)) {
        ...
        <p>Please open this link to verified your email address - ".$base_url."cd_email_verification.php?cd_activation_code=".$user_activation_code." <p>Best Regards, <br /> Voting</p>
        ";
