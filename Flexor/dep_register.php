...
if (isset($_POST['submit'])) 
 {
   ...
   }else
   {
      ...
      $insert_query = "
      INSERT INTO dh_register_user
      (DV_id, user_name, user_email, user_password, 
      user_activation_code, user_email_status) 
      VALUES (:DV_id, :user_name, :user_email, :user_password, 
      :user_activation_code, :user_email_status)
      ";
      ...
      if (isset($result)) {
        ...
        <p>Please open this link to verified your email address - ".$base_url."dep_email_verification.php?dh_activation_code=".$user_activation_code." <p>Best Regards, <br /> Voting</p>
        ";
                    ...
                    <div class="panel-body">
                      <form action="" method="post"   enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
                        ...
                        <div class="form-group has-feedback">
                          <input type="hidden" name="DV_id" value="<?php echo $_SESSION["DV_id"] ?>">
                        </div>
                        <div class="form-group has-feedback">
