...
if (isset($_POST['submit'])) {
  $count=0;
  $sql = mysqli_query($link, "select * from import_dep_data where DV_id = '$_POST[DV_id]' && Demail = '$_POST[Demail]' && L_name = '$_POST[lname]' && age = '$_POST[age]'");
  ...
  if ($count==0) {
    ...
    $_SESSION["email"] = $_POST['Demail'];
      ...
      <script type="text/javascript">
        window.location = "dep_register.php";
      </script>
              ...
              <div class="panel-heading"><h4></h4></div>
                    <div class="panel-body">
                      <form action="" method="post"   enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
                          ...
                          <input type="text" name="DV_id" class="form-control" placeholder="Your ID" data-parsley-required required="">
                        </div>
                        <div class="form-group">
                          <input type="email" name="Demail" class="form-control" placeholder="Your Email" dta-parsley-type="email" required="">
                        </div>
                        <div class="form-group">
                          <input type="text" name="lname" class="form-control" placeholder="Your Last Name" data-parsley-pattern="/^[A-Za-z]+$/" required="">
                        </div>
                        <div class="form-group">
