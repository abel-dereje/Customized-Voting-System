...
if (isset($_POST['submit'])) {
  ...
  if ($count==0) {
      ...
      <script type="text/javascript">
        alert("You are legibel. please check agin.");
      </script>
      <?php
   }else{
    ...
    $_SESSION["email"] = $_POST['Cemail'];
      ...
      <script type="text/javascript">
        window.location = "College_register.php";
      </script>
              ...
              <div class="panel-heading"><h4></h4></div>
                    <div class="panel-body">
                      <form action="" method="post"   enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
                          ...
                          <input type="text" name="CV_id" class="form-control" placeholder="Your ID" data-parsley-required required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <input type="text" name="bf" class="form-control" placeholder="Your Best Friend" data-parsley-pattern="/^[A-Za-z]+$/" required="">
                        </div>
         <div class="row">
        <!-- /.col -->
        <div class="col-xs-6">
