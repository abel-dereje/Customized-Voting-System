...
include "admin/admin/connction.php";
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <li class="active treeview">
          <ul class="treeview-menu"><br>
             <li class="active"><a href="index.php"><i class="fa fa-home"></i> <strong><?php echo lhome; ?></strong></a></li><br><br>
              <li><a href="about_us.php"><i class="fa fa-info"></i> <strong><?php echo labout_us; ?></strong></a></li><br><br>
              ...
              <li><a href="view_candidate.php"><i class="fa fa-users"></i> <strong><?php echo lview_candidate; ?></strong></a></li><br><br>
