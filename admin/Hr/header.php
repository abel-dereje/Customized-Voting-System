  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
            <li class="active"><a href="university_data.php"><i class="fa fa-file-excel-o"></i> <strong><?php echo luniversity;?></strong></a></li><br>
            <li><a href="dean_data.php"><i class="fa fa-file-excel-o"></i> <strong><?php echo lcd;?></strong></a></li><br>
            <li><a href="dep_data.php"><i class="fa fa-file-excel-o"></i> <strong><?php echo lcd;?></strong></a></li><br>
            <li><a href="student_data.php"><i class="fa fa-file-excel-o"></i> <strong><?php echo lcd;?></strong></a></li><br>
