...
<head>
  ...
  <title>National candidate page</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree"><br><br>
            <li class="active"><a href="view_candidate.php"><i class="fa fa-users"></i> <strong>Your Detail</strong></a></li><br>
            <br>
            <!--li><a href="dep_data.php"><i class="fa fa-file-excel-o"></i> <strong>Department Data</strong></a></li><br>
            <li><a href="student_data.php"><i class="fa fa-file-excel-o"></i> <strong>Student Data</strong></a></li><br>
            <li><a href="edit_profile.php"><i class="fa fa-user"></i> <strong>Student Data</strong></a></li-->
