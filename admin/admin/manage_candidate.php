  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Welcome to candidate of National Page
      </h1>
       <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                ?>                       
               <form method="post" enctype="multipart/form-data" action="manage_candidate.php" role="form">
                <input type="hidden" name="Cid" value="<?php echo $id; ?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="">Candidate Name</label>
                  <input type="text" class="form-control" name="Cname" value="<?php echo $name1; ?>" placeholder="Enter Candidate Name">
                </div><div class="form-group">
                  <label for="">Email address</label>
                  <input type="email" class="form-control" name="Cemail" value="<?php echo $email1; ?>" placeholder="Enter email">
                </div><div class="form-group">
                  <label for="">phone Number</label>
                  <input type="text" class="form-control" name="Cphone" value="<?php echo $phone1; ?>" placeholder="Enter Candidate Phone Number">
                </div><div class="form-group">
                  <label for="">Candidate Address</label>
                  <textarea rows="2" cols="56" name="Cadress" class="form-control"> </textarea>
                </div><div class="form-group">
                  <label for="">Candidate Description</label>
                  <textarea rows="2" cols="56" name="Cdescription" class="form-control"> </textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <?php
                   if ($update == true): ?>
                     ...
                     <?php else: ?>
                      <button type="Cancel" name="Cancel" class="btn btn-danger">Cancel</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="add" class="btn btn-primary">Add</button>
                <?php endif; ?>
                </div>
              </div>
            </form>
