    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Back up page</h3> 
      ...
      <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <h3><i> If you want to use backup file in .sql format, you can click here <br><br>
                <a class="fa fa-download" href="DB_backup.php">Click here</a> </i></h3>        
                </div>
          </div>
          <!-- /. box -->
        </div>                </div>
