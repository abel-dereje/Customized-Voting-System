  ...
  function Header()  {
        ...
        function viewTable($db)
        {
          ...
          while ($data = $stmt->fetch(PDO::FETCH_OBJ)) {
            ...
            $this->Cell(30,10,$data->Pname,1,0,'C');
            $this->Cell(50,10,$data->Pemail,1,0,'C');
            $this->Cell(35,10,$data->Pphone,1,0,'C');
            $this->Cell(60,10,$data->Paddress,1,0,'C');
            $this->Cell(60,10,$data->Pdisc,1,0,'C');
