          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <li><a href="../../change_lang.php?lang=2">አማርኛ</a></li-->
                <li><a href="edit_profile.php"><i class="fa fa-user"></i> <strong><?php echo ledit_profile;?></strong></a></li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="eb.jpg" class="img-circle" alt="User Image"><br>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="check_voter_list.php"><i class=""></i> <strong><?php echo lnational;?></strong></a></li><br>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-calendar-plus-o" ></i> <span><?php echo lmanage_duration; ;?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="manage_duration.php"><i class=""></i> <strong><?php echo lnational;?></strong></a></li><br>
            <li><a href="manage_duration_up.php"><i class=""></i> <strong><?php echo luniversity;?> </strong></a></li><br>
            <li><a href="manage_duration_cd.php"><i class=""></i> <strong><?php echo lcd;?> </strong></a></li><br>
            <li><a href="manage_duration_dh.php"><i class=""></i> <strong><?php echo ldh;?> </strong></a></li><br>
            <li><a href="manage_duration_su.php"><i class=""></i> <strong><?php echo lsu;?> </strong></a></li>
          </ul>
        </li><br>
        <li><a href="import_data.php"><i class="fa fa-file-excel-o"></i> <strong><?php echo limport_data; ?></strong></a></li><br>
            ...
            <li><a href="manage_contact.php"><i class="fa fa-contao"></i> <strong><?php echo lmanage_contact;?></strong></a>
            </li><br>
            <li><a href="manage_hompage.php"><i class="fa fa-home"></i> <strong><?php echo lmanage_homepage;?></strong></a></li><br>
            <li><a href="see_feedback.php"><i class="fa fa-comments"></i> <strong><?php echo lsee_feedback;?></strong></a></li><br>
            <li><a href="page_of_backup.php"><i class="fa fa-database"></i> <strong><?php echo lbackup;?></strong></a></li><br>
            
            <li><a href="manage_about_us.php"><i class="fa fa-user"></i> <strong><?php echo lmanage_aboutus;?></strong></a></li><br>
