...
$sql = "insert into import_university_data (`UV_id`, `name`, `M_name`, `L_name`, Mom_name, `age`, `sex`, `E_level`, `house_num`, `address`) values ('$emapData[0]','$emapData[1]','$emapData[2]','$emapData[3]','$emapData[4]','$emapData[5]','$emapData[6]','$emapData[7]','$emapData[8]','$emapData[9]')";
...
window.location = \"university_data.php\"
</script>";
}
}
fclose($file);
    ...
    <section class="content-header">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">University Data</h3>
       ...
       <div class="col-md-3 hidden-phone"></div>
                <div class="col-md-6" id="form-login">
                    <form class="well" action="university_data.php" method="post" name="upload_excel" enctype="multipart/form-data">
                        <fieldset>
