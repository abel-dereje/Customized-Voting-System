          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                    ...
                    <?php
                      while ($row = $result->fetch_assoc()): ?>
                          <tr>
                            ...
                            <img class="align-self-center rounded-circle mr-3" style="width:60px; height:35px;" src="<?php echo $row['Dimage'] ?>">
                          </div></td>
                ...
                ?>                       
               <form method="post" enctype="multipart/form-data" action="DH_candidate.php" role="form">
                <input type="hidden" name="Did" value="<?php echo $id; ?>">
              <div class="box-body">
                <div class="form-group">
                  <input type="text" class="form-control" name="Dname" value="<?php echo $name4; ?>" placeholder="Enter Full Name">
                </div><div class="form-group">
                  <input type="email" class="form-control" name="Demail" value="<?php echo $email4; ?>" placeholder="Enter email">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Dphone" value="<?php echo $phone4; ?>" placeholder="Enter Phone Number">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Dage" placeholder="Enter your age">
                </div><div class="form-group">
                ...
                <div class="form-group">
                  <label for="">File input</label>
                  <input type="file"  class="form-control" name="f12">
