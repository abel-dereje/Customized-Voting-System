    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Manage duration for college dean</h3>
      ...
      <div class="col-md-12">  
            ...
            <?php
                  ...
                  $result = $mysqli->query("SELECT * from manage_duration_cd") or die($mysqli->error);
                    ...
                    <?php
                      while ($row = $result->fetch_assoc()): ?>
                          <tr>
                            ...
                            <td>
                              <a href="manage_duration_cd.php?edit=<?php echo $row['manage_duration_cd_id']; ?>"
          ...
          <?php
              include "get_manage_duration_cd.php";
              ?>
          </div>
          <!-- /. box -->
        </div>                </div>
