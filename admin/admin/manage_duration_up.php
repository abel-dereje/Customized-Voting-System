    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Manage duration for university president</h3>
      ...
      <div class="col-md-12">  
            ...
            <?php
                  ...
                  $result = $mysqli->query("SELECT * from manage_duration_up") or die($mysqli->error);
                    ...
                    <?php
                      while ($row = $result->fetch_assoc()): ?>
                          <tr>
                            ...
                            <td>
                              <a href="manage_duration_up.php?edit=<?php echo $row['manage_duration_up_id']; ?>"
                                class ="btn btn-info"> Edit</a></td><td>
                                <!--a href="manage_duration.php?delete=<?php //echo $row['Cid']; ?>"
                ...
                ?> 
                 <?php
              include "get_manage_duration_up.php";
              ?>                      
