    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Manage duration for student union</h3>
      ...
      <div class="col-md-12">  
            ...
            <?php
                  ...
                  $result = $mysqli->query("SELECT * from manage_duration_su") or die($mysqli->error);
                    ...
                    <?php
                      while ($row = $result->fetch_assoc()): ?>
                          <tr>
                            ...
                            <td>
                              <a href="manage_duration_su.php?edit=<?php echo $row['manage_duration_su_id']; ?>"
                ...
                ?>  <br> <br> <br><br> <br>  
                   ...
                   <?php
              include "get_manage_duration_su.php";
              ?>                            
          </div>
          <!-- /. box -->
        </div>                </div>
