        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box-body">
                <div class="form-group">
                  <input type="text" class="form-control" name="Sname" id="Sname" value="<?php echo $name; ?>" placeholder="Enter Full Name">
                </div><div class="form-group">
                  <input type="email" class="form-control" name="Semail" id="Semail" value="<?php echo $email; ?>" placeholder="Enter email">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Sphone" id="Sphone" value="<?php echo $phone; ?>" placeholder="Enter Phone Number">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Sage" id="Sage" value="<?php //echo $age; ?>" placeholder="Enter your age ">
                </div><div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea rows="2" cols="56" name="Saddress" class="form-control" value="<?php //echo $address; ?>"> </textarea>
                </div>
                <div class="form-group">
                  <label for="">File input</label>
                  <input type="file"  class="form-control" name="f6">
