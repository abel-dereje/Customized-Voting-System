    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Manage duration for national voting</h3>
      ...
      <div class="col-md-12">  
            ...
            <?php
                  ...
                  $result = $mysqli->query("SELECT * from manage_duration") or die($mysqli->error);
                    ...
                    <?php
                      while ($row = $result->fetch_assoc()): ?>
                          <tr>
                            ...
                            <td>
                              <a href="manage_duration.php?edit=<?php echo $row['manage_duration_id']; ?>"
            ...
            <?php
              include "get_manage_duration.php";
              ?>
          </div>
          <!-- /. box -->
        </div>                </div>
