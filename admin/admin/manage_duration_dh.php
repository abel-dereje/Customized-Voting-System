    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Manage duration for department head</h3>
      ...
      <div class="col-md-12">  
            ...
            <?php
                  ...
                  $result = $mysqli->query("SELECT * from manage_duration_dh") or die($mysqli->error);
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                      while ($row = $result->fetch_assoc()): ?>
                          <tr>
                            ...
                            <td>
                              <a href="manage_duration_dh.php?edit=<?php echo $row['manage_duration_dh_id']; ?>"
                  ...
                  <?php
              include "get_manage_duration_dh.php";
              ?>                           
