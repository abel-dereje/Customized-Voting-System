 <?php
  include "header.php";
  $res=mysqli_query($link,"select votes from import_dep_data where DV_id = '$_SESSION[DV_id]'");
 ...
 ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="department_head.php"> <i class="fa fa-dashboard"> </i><strong><?php echo lback_home; ?> </strong></a> </li>
      </ol>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Vote your department candidate here</h3>
      ...
      <?php
        date_default_timezone_set('America/Chicago');
            ...
            $query = mysqli_query($link, "select * from manage_duration_dh");
          ...
          <?php
                        ...
                        ?>
                            ...
                            <div class="widget-user-header bg-aqua-active">
                              <h3 class="widget-user-username"> <?php echo $row['Dname']; ?></h3>
                             <h5 class="widget-user-desc"> <?php echo $row['DEL']; ?></h5><br><br><br><br>
                           </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                   ...
                   if($votes == 'yes') { 
                    ?>
                       <a style="pointer-events: none;"  href="vote_dep.php?Did=<?php echo $row["Did"]; ?>">
                        <?php 
                      ...
                      ?>
                        <a href="vote_dep.php?Did=<?php echo $row["Did"]; ?>">
                        <!--form class="form-disable" method="post" action="national_voting.php"-->
