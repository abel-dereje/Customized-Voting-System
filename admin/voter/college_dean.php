 <?php
  include "header.php";
  $res=mysqli_query($link,"select votes from import_college_data where CV_id = '$_SESSION[CV_id]'");
 ...
 ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="college_dean.php"> <i class="fa fa-dashboard"> </i><strong><?php echo lback_home; ?> </strong></a> </li>
      </ol>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Vote your college candidate here</h3>
        ...
        date_default_timezone_set('America/Chicago');
            ...
            $query = mysqli_query($link, "select * from manage_duration_cd");
          ...
          <?php
                        ...
                        ?>
                            ...
                            <div class="widget-user-header bg-aqua-active">
                             ...
                             <h5 class="widget-user-desc"> <?php echo $row['CEL']; ?></h5><br><br><br><br>
                           </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                   ...
                   if($votes == 'yes') { 
                    ?>
                       <a style="pointer-events: none;"  href="cd_vote.php?CDid=<?php echo $row["CDid"]; ?>">
                        <?php 
                      ...
                      ?>
                        <a href="cd_vote.php?CDid=<?php echo $row["CDid"]; ?>">
                        <!--form class="form-disable" method="post" action="national_voting.php"-->
