 <?php
  include "header.php";
            $res=mysqli_query($link,"select votes from import_university_data where UV_id = '$_SESSION[UV_id]'");
    ...
    <section class="content-header">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Vote your university candidate here</h3>
              ...
              <?php
                        ...
                        ?>
                            ...
                            <div class="widget-user-header bg-aqua-active">
                              <h3 class="widget-user-username"> <?php echo $row['Pname']; ?></h3>
                             <h5 class="widget-user-desc"> <?php echo $row['Pdisc']; ?></h5><br><br><br><br>
                           </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                   ...
                   if($votes == 'yes') { 
                    ?>
                       <a style="pointer-events: none;"  href="vot_up.php?Pid=<?php echo $row["Pid"]; ?>">
                        <?php 
                      ...
                      <input type="submit" name="update1" value="Vote Now" class="btn btn-block btn-default disabled">
                      </a> <?php
                    }else{
                      ?>
                        <a href="vot_up.php?Pid=<?php echo $row["Pid"]; ?>">
                          
                        <!--form class="form-disable" method="post" action="national_voting.php"-->
                      <input type="submit" name="update1" value="Vote Now" class="btn btn-info">
                      </a>
                      <?php
                      }
                       ?>
