        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <li><a href="logout.php"><i class= "fa fa-sign-out"></i><?php echo lsign_out;?> </a></li>
            </a>
            <ul class="dropdown-menu">
              <!-- Menu Footer-->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu"><br>
            <li class="active"><a href="national_voting.php"><i class="fa fa-hand-o-right"></i> <strong><?php echo lvote_online; ?></strong></a></li><br>
