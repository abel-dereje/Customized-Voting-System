        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box-body">
                <div class="form-group">
                  <input type="text" class="form-control" name="Cname" placeholder="Enter Your name" data-parsley-pattern="/^[A-Za-z]+$/" required="">
                </div><div class="form-group">
                  <input type="email" class="form-control" name="Cemail" value="<?php echo $email3; ?>" placeholder="Enter email" data-parsley-type="email" required="">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Cphone" value="<?php echo $phone3; ?>" placeholder="Enter Phone Number" namedata-parsley-pattern="/^\d{10}$/" required="">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Cage" placeholder="Enter your age" data-parsley-type = "number" required="">
                </div><div class="form-group">
                  <label for="">File input</label>
                  <input type="file"  class="form-control" name="f3" data-parsley-required required="">
                ...
                <div class="form-group">
                  ...
                  <textarea rows="2" cols="56" name="Caddress" id="Cadrdess" class="form-control" data-parsley-required required=""> </textarea>
                </div>
                <div class="form-group">
                  <label for="">File input</label>
                  <input type="file"  class="form-control" name="f4" data-parsley-required required="">
