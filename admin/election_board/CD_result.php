    ...
    <section class="content-header">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">College Dean Resultt</h3>
          ...
          <div class="row">
            <div class="col-md-12">
                <div class="coantainer">
                  <table class="table">
                    <a href="CD_result_pdf.php" class="btn btn-success">Download Leave PDF</a>
                    <thead>
                      <tr>
                        <th>Image</th>
                        <th>Name</th>
                    ...
                    <?php 
                          $sql = "SELECT image, Cname, Cemail, Cphone, CEL, Caddress, vote from cd";
