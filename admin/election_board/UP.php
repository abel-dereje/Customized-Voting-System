        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box-body">
                <div class="form-group">
                  <input type="text" class="form-control" name="Pname" value="<?php echo $name2; ?>" placeholder="Enter Full Name" data-parsley-pattern="/^[A-Za-z]+$/" required="">
                </div><div class="form-group">
                  <input type="email" class="form-control" name="Pemail" value="<?php //echo $email2; ?>" placeholder="Enter email" data-parsley-type="email" required="">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Pphone" value="<?php echo $phone2; ?>" placeholder="Enter Phone Number" data-parsley-required required="">
                </div><div class="form-group">
                  <input type="text" class="form-control" name="Page" placeholder="Enter your age " data-parsley-type = "number" required="">
                </div><div class="form-group">
                  <label for="">File input</label>
                  <input type="file" class="form-control" name="f222" data-parsley-required required="">
                  <p class="help-block">Enter Your expriance in Image formate</p>
                </div>  
                <div class="form-group">
                  <select name="PEL" class="form-control" data-parsley-required required="">
                ...
                <div class="form-group">
                  <select name="Psex" class="form-control" data-parsley-required required="">
                    <option>Male</option>
                    <option>Female</option>
                  </select>
                </div><div class="form-group">
                  <label for="">President Address</label>
                  <textarea rows="2" cols="56" name="Paddress" class="form-control" data-parsley-required required=""> </textarea>
                </div><div class="form-group">
                  <label for="">President Description</label>
                  <textarea rows="2" cols="56" name="Pdisc" id="Pdisc" class="form-control" data-parsley-required required=""> </textarea>
                </div>
                <div class="form-group">
                  <label for="">File input</label>
                  <input type="file"  class="form-control" name="f111" data-parsley-required required="">
