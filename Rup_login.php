...
var email = document.forms["vform"]["user_email"];
                  ...
                  <div class="row justify-content-center">  
                        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                          <ul class="nav navbar-nav">
                            <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><label class="form-group">For which voting is? </label><span class="caret"></span></a>
                              <ul class="dropdown-menu" role="menu">
                                <li><a href="Qnational.php">To National vote</a></li>
                                <li><a href="Qup.php">To University President vote</a></li>
                                <li><a href="Qcd.php">To College Dean vote</a></li>
                                <li><a href="Qdh.php">To Department Head vote</a></li>
                                <li><a href="Qsu.php">To Student Union vote</a></li>
                              </ul>
                            </li>
                          </ul>
                        </div>
